...
import {
  ...
  Home, TrendingUp, AlertTriangle, Wifi, WifiOff, CalendarClock, Image as ImageIcon, Check, Circle,
} from "lucide-react";
  ...
  return (
    <div className="app">
      ...
      <header className="barra">
        <span className="logo">Mi plata <span className="sello-version">v8 · mes a mes</span></span>
